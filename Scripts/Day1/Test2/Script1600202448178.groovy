...
WebUI.rightClick(findTestObject('Web/Page_OrangeHRM/a_Welcome Linda'))

WebUI.click(findTestObject('Web/Page_OrangeHRM/div_Welcome Linda                          _eed1bc'))

WebUI.click(findTestObject('Web/Page_OrangeHRM/a_Welcome Linda'))
